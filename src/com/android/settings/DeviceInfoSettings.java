...
public class DeviceInfoSettings extends PreferenceActivity {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        findPreference("kernel_version").setSummary("2.6.35.14-xinge@style#8");
        ...
        findPreference("devid").setSummary("Xinge");
	     findPreference("thanks").setSummary("CM,Teamfun,cyanmobile");
